...
#define IOCTL_EZI_KERNEL_NATIVE_INJECT CTL_CODE(EZI_DEVICE_TYPE, 0x801, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_EZI_KERNEL_MANUAL_MAP    CTL_CODE(EZI_DEVICE_TYPE, 0x802, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
